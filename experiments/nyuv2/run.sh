...
python trainer.py --method=$method --seed=$seed --gamma=$gamma --n_epochs=$n_epochs --lr=$lr --batch_size=$batch_size --num_agents=$num_agents --network_sparsity=$network_sparsity > trainlogs/log_$method-gamma$gamma-$seed-batch$batch_size-agent$num_agents-sparsity$network_sparsity.log 2>&1 &
# method=sdmgrad
# seed=42
# lamda=0.3
# niter=20
