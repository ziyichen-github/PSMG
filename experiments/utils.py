...
common_parser.add_argument("--batch-size", type=int,
                           default=120, help="batch size")
...
# cagrad
common_parser.add_argument(
    "--c", type=float, default=0.4, help="c for CAGrad alg.")
# fairgrad
common_parser.add_argument("--alpha", type=float,
                           default=1.0, help="alpha for FairGrad alg.")
# sdmgrad
common_parser.add_argument("--lamda", type=float,
                           default=0.3, help="lambda for SDMGrad alg.")
common_parser.add_argument(
    "--niter", type=int, default=20, help="niter for SDMGrad alg.")
# famo
common_parser.add_argument("--gamma", type=float,
                           default=0.01, help="gamma of famo")
common_parser.add_argument(
    "--use_log", action='store_true', help="whether use log for famo")
common_parser.add_argument("--max_norm", type=float,
                           default=1.0, help="beta for RMS_weight alg.")
common_parser.add_argument(
    "--task", type=int, default=0, help="train single task number for (celeba)")
# dwa
common_parser.add_argument(
    "--dwa-temp",
    type=float,
...
def extract_weight_method_parameters_from_args(args):
    ...
    weight_methods_parameters.update(
        dict(
            ...
            sdmgrad=dict(lamda=args.lamda, niter=args.niter,
                         max_norm=args.max_norm),
        )
    )
